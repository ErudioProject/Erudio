...
export type Procedures = {
  queries:
    ...
    | {
        ...
        input: never;
        result: {
          two_factor_auth_settings: { previous_data: Array<any> } | null;
          pii_data: {
          ...
          user_school_relation: Array<{
            school: {
              name: string;
              previous_data: Array<any>;
              school_settings: { previous_data: Array<any> } | null;
            };
          }>;
        };
      };
  mutations: { key: 'public.register'; input: RegisterRequest; result: null };
  subscriptions: never;
};
