...
export type Procedures = {
    queries: 
        ...
        { key: "user.me", input: never, result: { two_factor_auth_settings: { placeholder_field: string } | null, pii_data: { grammatical_form: GrammaticalForm, email: string | null, pesel: string | null, birth_date: string | null, legal_name: string | null, display_name: string | null, phone_prefix: string | null, phone_number: string | null } | null } },
    mutations: 
